...
export const policy = {
  ...
  /**
   * Randomized face actions, issued by the server at selfie time for every session (and again for a
   * step-up re-verification). Unpredictable order = nothing can be recorded in advance; each action is
